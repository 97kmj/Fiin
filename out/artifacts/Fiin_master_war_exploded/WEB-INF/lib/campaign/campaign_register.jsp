        ...
        <div class="form-group-group">
            <div class="form-group1">
                ...
                <select id="uploadPeriod" name="uploadPeriod">
                    <option value="${campaign.uploadPeriod == '1주일' ? '1주일' : ''}">1주일 500 point</option>
                    <option value="${campaign.uploadPeriod == '2주일' ? '2주일' : ''}">2주일 1000 point</option>
                    <option value="${campaign.uploadPeriod == '3주일' ? '3주일' : ''}">3주일 1500 point</option>
                    <option value="${campaign.uploadPeriod == '4주일' ? '4주일' : ''}">4주일 1800 point</option>
                </select>
            </div>
