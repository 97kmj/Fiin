...
public class Advertiser {
  ...
  public String toString() {
    return "Advertiser [advertiserNum=" + advertiserNum + ", userEmail=" + userEmail + ", password="
        + password
        + ", name=" + name + ", companyName=" + companyName + ", mobileNumber=" + mobileNumber
        + ", createAt="
        + createAt + ", pointBalance=" + pointBalance + ", address=" + address + "]";
  }

  public Advertiser(Integer advertiserNum, String userEmail, String password, String name,
      String companyName,
