...
public class Campaign {
  ...
  public Campaign(Integer campaignNum, Integer advertiserNum, Integer categoryId,
      String companyName,
      String companyUrl, String campaignTitle, String productName, Date updateStartDate,
      Date updateEndDate,
      Date adStartDate, Date adEndDate, String channel, String image, Integer isRecruit,
      String address) {
    super();
  ...
  public String toString() {
    return "Campaign [campaignNum=" + campaignNum + ", advertiserNum=" + advertiserNum
        + ", categoryId="
        + categoryId + ", companyName=" + companyName + ", companyUrl=" + companyUrl
        + ", campaignTitle="
        + campaignTitle + ", productName=" + productName + ", updateStartDate=" + updateStartDate
        + ", updateEndDate=" + updateEndDate + ", adStartDate=" + adStartDate + ", adEndDate="
        + adEndDate
        + ", channel=" + channel + ", image=" + image + ", isRecruit=" + isRecruit + ", address="
        + address
        + "]";
  }

  public Campaign(Integer campaignNum, Integer categoryId, String companyName, String campaignTitle,
      String productName, Date updateStartDate, Date updateEndDate, Date adStartDate,
      Date adEndDate,
