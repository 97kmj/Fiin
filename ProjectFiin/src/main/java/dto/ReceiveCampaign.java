...
=======
	...
	public String toString() {
		return "ReceiveCampaign [applyNum=" + applyNum + ", campaignNum=" + campaignNum + ", influencerNum="
				+ influencerNum + ", accept=" + accept + "]";
	}
	public ReceiveCampaign(Integer applyNum, Integer campaignNum, Integer influencerNum, Integer accept) {
		super();
		this.applyNum = applyNum;
		this.campaignNum = campaignNum;
		this.influencerNum = influencerNum;
