...
public class Campaign {
	...
	public Campaign(String channel, String companyName, String companyUrl, String campaignTitle, String productName,
			Timestamp updateStartDate, Timestamp updateEndDate, Timestamp adStartDate, Timestamp adEndDate,
			Integer categoryId) {
		this.channel = channel;
		this.companyName = companyName;
		this.companyUrl = companyUrl;
